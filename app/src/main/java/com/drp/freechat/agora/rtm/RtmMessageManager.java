...
import com.drp.freechat.App;
import com.drp.freechat.agora.rtm.model.ChatMessage;
import com.drp.freechat.agora.rtm.model.GiftMessage;
import com.drp.freechat.agora.rtm.model.GiftRankMessage;
import com.drp.freechat.agora.rtm.model.NotificationMessage;
import com.drp.freechat.agora.rtm.model.OwnerStateMessage;
import com.drp.freechat.agora.rtm.model.PKMessage;
import com.drp.freechat.agora.rtm.model.PeerMessageData;
import com.drp.freechat.agora.rtm.model.SeatStateMessage;
...
public class RtmMessageManager implements RtmClientListener, RtmChannelListener {
    ...
    public void sendPeerMessage(String userId, String message, ResultCallback<Void> callback) {
    ...
    public void onMessageReceived(RtmMessage rtmMessage, final String peerId) {
        ...
        Log.i(App.TAG, String.format("onMessageReceived: %s, %s", peerId, rtmMessage.getText()));
    ...
    public void onMessageReceived(RtmMessage rtmMessage, RtmChannelMember fromMember) {
        Log.i(App.TAG, String.format("onChannelMessageReceived: %s, %s", rtmMessage.getText(), fromMember.getUserId()));
    ...
    public void onMemberJoined(RtmChannelMember rtmChannelMember) {
        Log.i(App.TAG, String.format("onMemberJoined: %s, %s", rtmChannelMember.getUserId(), rtmChannelMember.getChannelId()));
        for (RtmMessageListener listener : mMessageListeners) {
            listener.onRtmMemberJoined(rtmChannelMember);
        }
    }

    @Override
    public void onMemberLeft(RtmChannelMember rtmChannelMember) {
        Log.i(App.TAG, String.format("onMemberLeft: %s, %s", rtmChannelMember.getUserId(), rtmChannelMember.getChannelId()));
        for (RtmMessageListener listener : mMessageListeners) {
            listener.onRtmMemberLeft(rtmChannelMember);
        }
    }
}
